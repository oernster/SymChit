...
// HomeURL is where SymChit lives. Like DonateURL it is only ever printed or
// handed to the desktop; nothing here opens a connection of its own.
const HomeURL = "https://symchit.com"
...
// not Statement: that one speaks to the person using SymChit, while this one
...
// purpose SymChit does not have (REQUIREMENTS.md 4.1).
